...
function render() {
  ...
  if (unCompletedTodos.length > 0) {
    ...
    uncompletedTodosDiv.innerHTML = `<div class='empty'>No uncompleted misson</div>`;
  }
...
function createTodoElement(todo) {
  ...
  todoDiv.className = "todo-item"; // Adicione a classe "todo-item"
  ...
  todoRemoveBtn.onclick = (e) => {
    ...
    // Atualize a renderização após remover o item
    render();

    return false; // Adicione esta linha para evitar que o link siga o href
  };

  // Agora, você deve anexar os elementos criados à div "todoDiv"
  todoDiv.appendChild(todoInputCheckbox);
  todoDiv.appendChild(todoTextSpan);
  todoDiv.appendChild(todoRemoveBtn);

  return todoDiv; // Retorna a div criada com a classe "todo-item"
}
